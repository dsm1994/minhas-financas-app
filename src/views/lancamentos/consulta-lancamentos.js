...
class ConsultaLancamentos extends React.Component {
    ...
    deletar = (lancamento) => {
        this.service.deletar(this.state.lancamentoDeletar.id)
                    ...
                    .catch(error => {messages.mensagemErro("Ocorreu um erro ao tentar deletar o Lançamento.")})
    }

    preparaFormularCadastro = () => {
    ...
    render() {
        ...
        return (
            <Card title="Consulta Lançamentos">
                    ...
                    <div className="col-md-6">
                        <div className="bs-component">
                            ...
                            <FormGroup label="Descrição:" htmlFor="inputDesc">
                                <input type="text" className="form-control" id="inputDesc" value={this.state.descricao} onChange={e => this.setState({descricao: e.target.value})} placeholder="Digite a descrição" />
                            </FormGroup>
                            ...
                            <button onClick={this.preparaFormularCadastro} type="button" className="btn btn-danger"><i className="pi pi-plus"></i> Cadastrar</button>
                        </div>
                    </div>
                </div>
                <br />
                ...
                <div>
                    <Dialog header="Confirmação" visible={this.state.showConfirmDialog} style={{width: "50vw"}} footer={confirmDialogFooter} onHide={() => this.setState({showConfirmDialog: false})}>
